...
const DEFAULT_INFOS = (): Record<AgentKey, AgentInfo> => ({
  ...
  marketing:  { status: "idle", lastActive: "—" },
  data:       { status: "idle", lastActive: "—" },
  finance:    { status: "idle", lastActive: "—" },
  operations: { status: "idle", lastActive: "—" },
  trust:      { status: "idle", lastActive: "—" },
  meta:       { status: "idle", lastActive: "—" },
